...
export const PluginManager = {
    ...
    async init(builderAPI) {
        // FIXED: Used '../../' to step back from 'scripts/core/' to the root directory
        const pluginsToLoad = [
            '../../plugins/sample-widget/plugin.js' 
        ];

        console.log("Initializing Plugins...");

        const promises = pluginsToLoad.map(url => this.loadPlugin(url, builderAPI));
